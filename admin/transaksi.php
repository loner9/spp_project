...
<div class="container" style="margin-top:30px">
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-md-10"><b>Riwayat Pembayaran</b></div>
                <div class="col-sm-1">
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped">
                    <tr>
                        <th>NISN</th>
                        <td><span id="nisn"><?php echo $_GET["student_id"] ?></span></td>
                    </tr>
                    <tr>
                        <th>Nama Siswa</th>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-md-8">
                                        <input type="text" step="125000" value="125000" oninput="
                                        document.getElementById('rVal').innerHTML = this.value;
                                        document.getElementById('rMon').innerHTML = this.value/125000" name="paym_amount" id="paym_amount" class="form-control" />
                                    </div>
                                    <p id="rVal">125000</p>
                                    <p>&nbsp;/&nbsp;</p>
                                    <p id="rMon">1</p>
...
<script>
    $(document).ready(function() {
        ...
        $('#report_button').click(function(){
            var student_id = $('#nisn').text();
            var paym_id = <?php echo $_GET["paym_id"] ?>;
            window.open("report.php?action=student_report&student_id="+student_id+"&paym_id="+paym_id);
        });
